...
int main()
{
    ...
    runnable *controller_runnable = new wrapper<Controller>(controller_class, controller_uPorts, controller_yPorts, 2, 1);
    ...
    runnable *plant_runnable = new wrapper<Plant>(plant_class, plant_uPorts, plant_yPorts, 1, 1);
